<header class="bg-mydark text-white p-1 flex justify-between items-center z-1000 top-0 left-0 w-full fixed rounded-br-20px rounded-bl-20px border-t-0 border-2 border-solid border-mygray">
