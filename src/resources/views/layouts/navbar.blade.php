<header class="bg-mydark text-white p-1 flex justify-between items-center h-50px z-1000 top-0 w-full fixed rounded-br-20px rounded-bl-20px border-t-0 border-2 border-solid border-mygray">
    <a href=""><img src="assets/images/logo.png" alt="Logo" class="shrink-0 justify-center items-center max-w-[100px] h-[50px] mr-auto py-2"></a>
