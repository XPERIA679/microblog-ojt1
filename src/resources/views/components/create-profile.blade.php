    ...
    <div class="form-container">
        ...
        <form action="#" id="signup-form">
            <div class="user-details">
                ...
                <div class="input-box">
                    <input type="text" name="first_name" placeholder="Juan" autocomplete="off" required>
                    <span>First Name</span>
                </div>

                <div class="input-box">
                    <input type="text" name="last_name" placeholder="Dela Cruz" autocomplete="off" required>
                    <span>Last Name</span>
                </div>

                <div class="input-box">
                    <input type="date" name="birth_date" id="bday" required>
                    <span>Birthday</span>
                </div>

                <div class="input-box">
                    <input type="text" name="contact" placeholder="09123456789" pattern="[0-9]{11}" autocomplete="off" required>
