...
class UserPostController extends Controller
{
    ...
    public function create(CreateUserPostRequest $request): RedirectResponse
    {
        ...
        return redirect('/posts-page')->with('notifMessage', 'Post Created Successfully!');
    }
    ...
    public function edit(EditUserPostRequest $request):RedirectResponse
    {
        ...
        return redirect('/')->with('notifMessage', 'Post Edited Successfully!');
    }
    ...
    public function likePost(Request $request):RedirectResponse
    {
        ...
        return redirect('/posts-page')->with('notifMessage', 'Post Liked Successfully!');
    }
    ...
    public function unlikePost(Request $request):RedirectResponse
    {
        ...
        return redirect('/posts-page')->with('notifMessage', 'Post Unliked Successfully!');
    }
}
