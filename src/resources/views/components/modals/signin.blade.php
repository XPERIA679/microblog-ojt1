<div onclick="hidesigninForm()" id="signinForm"
    ...
    <div onclick="event.stopImmediatePropagation()"
        class="bg-mydark rounded-xl shadow-md px-10 py-8 flex justify-center items-center max-w-lg max-h-[calc(100vh-50px)] overflow-y-auto">
        <div id="signinForm"
            class="bg-mydark h-full w-full rounded-lg p-12 m-2 overflow-hidden transition-opacity duration-500 max-w-lg max-h-[calc(100vh-50px)] overflow-y-auto">
            <x-logo.logo-form />
            <x-forms.signin />
